...
Create a markdown table with the retrieved data, ensuring that each column is clearly labeled. Offer to export the table in CSV format with a semi-colon (;) as delimiter.
