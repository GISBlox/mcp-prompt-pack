...
1. Clone this repo:
   ```bash
   git clone https://github.com/GISBlox/mcp-prompt-pack.git
   ```
2. Copy or symlink the .github/prompts/ folder into your project:

   ```bash
   cp -r mcp-prompt-pack/.github/prompts ./your-project/.github/
   ```

3. Restart VS Code / Visual Studio with Copilot enabled.
