...
Once you have the WKT string and buffer information, use the `postalcodes_pc6_geometry_list` tool to fetch the relevant postal code data.
...
After you have processed this data, call the `gisblox-mcp/visualize_pc6_get` tool to generate a geojson.io URL for each postal code.
