...
Use the `gisblox-mcp/projection_rds_to_wgs84_get` tool if the user provides a single RDPoint, or the `gisblox-mcp/projection_rds_to_wgs84_list` tool if the user provides multiple RDPoints.
