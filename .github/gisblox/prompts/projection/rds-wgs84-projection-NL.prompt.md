...
Gebruik de `gisblox-mcp/RdsToWgs84` tool als de gebruiker één RDPoint opgeeft, of de `gisblox-mcp/RdsToWgs84List` tool als de gebruiker meerdere RDPoints opgeeft.
